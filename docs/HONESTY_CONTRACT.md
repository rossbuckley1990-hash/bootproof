...
6. **Failures are classified, evidenced, and preserved.** Every failed run writes a failed attestation with a taxonomy class and the raw output tail. Unclassifiable failures say `unknown_failure` — never a guess.
